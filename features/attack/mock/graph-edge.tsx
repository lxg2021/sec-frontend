...
import type { ProcessCreateShip } from "@/features/attack/graph/edge/process-create-ship";
import type { ReverseProcessCreateFileShip } from "@/features/attack/graph/edge/process-create-file-ship";
import type { ProcessNetShip } from "@/features/attack/graph/edge/process-net-ship";
import type { ProcessDnsShip } from "@/features/attack/graph/edge/process-dns-ship";
import type { ProcessTerminateShip } from "@/features/attack/graph/edge/process-terminate-ship";
import type { ProcessAccessShip } from "@/features/attack/graph/edge/process-access-ship";
import type { NetDnsShip } from "@/features/attack/graph/edge/net-dns-ship";
import type { NetLateralMovementShip } from "@/features/attack/graph/edge/net-lateral-movement-ship";
import type { ReverseProcessAccessVolumeShip } from "@/features/attack/graph/edge/process-access-volume-ship";
import type { ReverseProcessDeleteFileShip } from "@/features/attack/graph/edge/process-delete-file-ship";
import type { ReverseProcessReadFileShip } from "@/features/attack/graph/edge/process-read-file-ship";
import type { ReverseProcessWriteFileShip } from "@/features/attack/graph/edge/process-write-file-ship";
import type { ReverseProcessSetFileEaShip } from "@/features/attack/graph/edge/process-set-file-ea-ship";
import type { ReverseProcessRenameFileShip } from "@/features/attack/graph/edge/process-rename-file-ship";
import type { RenameFilePeerShip } from "@/features/attack/graph/edge/rename-file-peer-ship";
import type { ReverseProcessMoveFileShip } from "@/features/attack/graph/edge/process-move-file-ship";
import type { MoveFilePeerShip } from "@/features/attack/graph/edge/move-file-peer-ship";
import type { ReverseProcessChangeFileAttributesShip } from "@/features/attack/graph/edge/process-change-file-attributes-ship";
import type { ReverseProcessCreateFileStreamShip } from "@/features/attack/graph/edge/process-create-file-stream-ship";
import type { ReverseProcessDeleteFileStreamShip } from "@/features/attack/graph/edge/process-delete-file-stream-ship";
import type { FilePeerStreamShip, StreamPeerFileShip } from "@/features/attack/graph/edge/stream-peer-file-ship";
import type { NewFilePeerStreamShip } from "@/features/attack/graph/edge/new-file-peer-stream-ship";
import type { ReverseProcessBitsCreateShip } from "@/features/attack/graph/edge/process-bits-create-ship";
import type { ReverseProcessBitsAddFileShip } from "@/features/attack/graph/edge/process-bits-add-file-ship";
import type { ReverseProcessBitsStatusChangeShip } from "@/features/attack/graph/edge/process-bits-status-change-ship";
import type { ReverseProcessCreateTaskShip } from "@/features/attack/graph/edge/process-create-task-ship";
import type { FileTaskImageMd5PeerShip, ReverseFileTaskImageMd5PeerShip } from "@/features/attack/graph/edge/file-task-image-md5-peer-ship";
import type { TaskLateralMovementShip } from "@/features/attack/graph/edge/task-lateral-movement-ship";
import type { ReverseProcessDeleteTaskShip } from "@/features/attack/graph/edge/process-delete-task-ship";
import type { ReverseProcessCrossMemoryExecuteShip } from "@/features/attack/graph/edge/process-cross-memory-execute-ship";
import type { ReverseProcessDllLoadShip } from "@/features/attack/graph/edge/process-dll-load-ship";
import type { ReverseFileDllImageMd5PeerShip, FileDllImageMd5PeerShip } from "@/features/attack/graph/edge/file-dll-image-md5-peer-ship";
import type { ReverseProcessDriverLoadShip } from "@/features/attack/graph/edge/process-driver-load-ship";
import type { ReverseFileDriverImageMd5PeerShip, FileDriverImageMd5PeerShip } from "@/features/attack/graph/edge/file-driver-image-md5-peer-ship";
import type { ReverseProcessEnDecryptShip } from "@/features/attack/graph/edge/process-en-decrypt-ship";
import type { ReverseProcessCreateEventShip } from "@/features/attack/graph/edge/process-create-event-ship";
import type { ReverseProcessOpenEventShip } from "@/features/attack/graph/edge/process-open-event-ship";
import type { ReverseProcessCreateFileMappingShip } from "@/features/attack/graph/edge/process-create-file-mapping-ship";
import type { ReverseProcessConnectFileMappingShip } from "@/features/attack/graph/edge/process-connect-file-mapping-ship";
import type { ReverseProcessCreateMailSlotShip } from "@/features/attack/graph/edge/process-create-mail-slot-ship";
import type { ReverseProcessConnectMailSlotShip } from "@/features/attack/graph/edge/process-connect-mail-slot-ship";
import type { ReverseProcessModifyMbrShip } from "@/features/attack/graph/edge/process-modify-mbr-ship";
import type { ReverseProcessCreatePipeShip } from "@/features/attack/graph/edge/process-create-pipe-ship";
import type { ReverseProcessConnectPipeShip } from "@/features/attack/graph/edge/process-connect-pipe-ship";
import type { ReverseProcessPowershellShip } from "@/features/attack/graph/edge/process-powershell-ship";
import type { ReverseProcessCreateRegKeyShip } from "@/features/attack/graph/edge/process-create-reg-key-ship";
import type { ReverseProcessDeleteRegKeyShip } from "@/features/attack/graph/edge/process-delete-reg-key-ship";
import type { ReverseProcessRenameRegKeyShip } from "@/features/attack/graph/edge/process-rename-reg-key-ship";
import type { RenameRegKeyPeerShip } from "@/features/attack/graph/edge/rename-reg-key-peer-ship";
import type { ReverseProcessSetRegValueShip } from "@/features/attack/graph/edge/process-set-reg-value-ship";
import type { ReverseProcessDeleteRegValueShip } from "@/features/attack/graph/edge/process-delete-reg-value-ship";
import type { ReverseProcessQueryRegValueShip } from "@/features/attack/graph/edge/process-query-reg-value-ship";
import type { ReverseProcessStealingCredentialsShip } from "@/features/attack/graph/edge/process-stealing-credentials-ship";
import type { ReverseProcessAdjuestPrivilegeShip } from "@/features/attack/graph/edge/process-adjuest-privilege-ship";
import type { ReverseProcessImpersonationTokenShip } from "@/features/attack/graph/edge/process-impersonation-token-ship";
import type { ReverseProcessSetTokenShip } from "@/features/attack/graph/edge/process-set-token-ship";
import type { ReverseProcessHookMessageShip } from "@/features/attack/graph/edge/process-hook-message-ship";
import type { ReverseProcessUrlShip } from "@/features/attack/graph/edge/process-url-ship";
import type { ReverseProcessCreateWmiClassShip } from "@/features/attack/graph/edge/process-create-wmi-class-ship";
import type { ReverseProcessQueryWmiShip } from "@/features/attack/graph/edge/process-query-wmi-ship";
import type { ReverseProcessExecuteWmiShip } from "@/features/attack/graph/edge/process-execute-wmi-ship";
import type { ReverseProcessWmiConsumerShip } from "@/features/attack/graph/edge/process-wmi-consumer-ship";
import type { ReverseProcessWmiFilterShip } from "@/features/attack/graph/edge/process-wmi-filter-ship";
import type { ConsumerFilterBindingShip } from "@/features/attack/graph/edge/consumer-filter-binding-ship";
import type { WmiLateralMovementShip } from "@/features/attack/graph/edge/wmi-lateral-movement-ship";
import type { DeviceAgentShip } from "@/features/attack/graph/edge/device-change-ship";
import type { ReverseProcessCreateServiceShip } from "@/features/attack/graph/edge/process-create-service-ship";
import type { ReverseProcessStartServiceShip } from "@/features/attack/graph/edge/process-start-service-ship";
import type { ReverseProcessDeleteServiceShip } from "@/features/attack/graph/edge/process-delete-service-ship";
import type { ReverseProcessStopServiceShip } from "@/features/attack/graph/edge/process-stop-service-ship";
import type { ReverseProcessPauseRestoreServiceShip } from "@/features/attack/graph/edge/process-pause-restore-service-ship";
import type { ReverseProcessChangeServiceShip } from "@/features/attack/graph/edge/process-change-service-ship";
import type { FileServiceImageMd5PeerShip, ReverseFileServiceImageMd5PeerShip } from "@/features/attack/graph/edge/file-service-image-md5-peer-ship";
import type { ReverseProcessCreateAccountShip } from "@/features/attack/graph/edge/process-create-account-ship";
import type { ReverseProcessEnableAccountShip } from "@/features/attack/graph/edge/process-enable-account-ship";
import type { ReverseProcessResetAccountPwdShip } from "@/features/attack/graph/edge/process-reset-account-pwd-ship";
import type { ReverseProcessDisableAccountShip } from "@/features/attack/graph/edge/process-disable-account-ship";
import type { ReverseProcessDeleteAccountShip } from "@/features/attack/graph/edge/process-delete-account-ship";
import type { ReverseProcessModifyAccountShip } from "@/features/attack/graph/edge/process-modify-account-ship";
import type { ReverseProcessAddAccountGroupShip } from "@/features/attack/graph/edge/process-add-account-group-ship";
import type { ReverseProcessDeleteAccountGroupShip } from "@/features/attack/graph/edge/process-delete-account-group-ship";
import type { ReverseProcessCreateGroupShip } from "@/features/attack/graph/edge/process-create-group-ship";
import type { ReverseProcessDeleteGroupShip } from "@/features/attack/graph/edge/process-delete-group-ship";
