...
export type AttackGraphPreferredEdgeShape =
  | "straight"
  | "orthogonal"
  | "curved"
  | "loop";
...
export interface AttackGraphRelationLayoutRule {
  ...
  priority: number;
  preferredShape: AttackGraphPreferredEdgeShape;
...
> = {
  ...
  CASE_HAS_GROUP: relationRule("case-structure", "hidden", 10, "straight", true),
...
export function getAttackGraphRelationLayoutRule(
  ...
  return relationRule("unknown", "side", 1, "curved", false);
}
