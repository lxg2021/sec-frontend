...
interface HostAssetPageProps {
  listTitle: string
  listDescription: string
  listIcon: ComponentType<{ className?: string }>
  loadingSummaryText: string
  loadingListText: string
  summaryLoadFailedText: string
  listLoadFailedText: string
  retryText: string
  refreshText: string
...
export function HostAssetPage({
  listTitle,
  listDescription,
  listIcon: ListIcon,
  loadingSummaryText,
  loadingListText,
  summaryLoadFailedText,
  listLoadFailedText,
  retryText,
  refreshText,
  totalLabel,
  ...
  const loadSummary = useCallback(async () => {
    ...
    try {
      ...
      setSummary(null)
      setSummaryError(error instanceof Error ? error.message : summaryLoadFailedText)
    } finally {
  ...
  const loadHosts = useCallback(async () => {
    ...
    try {
      ...
      setHostsError(error instanceof Error ? error.message : listLoadFailedText)
    } finally {
      setHostsLoading(false)
    }
  }, [listLoadFailedText, page, pageSize])
