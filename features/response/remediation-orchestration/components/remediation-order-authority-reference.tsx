...
export function RemediationOrderAuthorityReference({
  ...
  return (
    <div
      className={`${fileRestore ? "mt-4" : "mb-4"} grid gap-3 rounded-2xl border border-blue-200 bg-blue-50 p-4`}
    >
      <div>
        <div className="text-xs font-semibold text-blue-900">
          {fileRestore ? t("reference.restoreTitle") : t("reference.title")}
        </div>
        <p className="mt-1 text-xs leading-5 text-blue-700">
          {fileRestore
            ? t("reference.restoreDescription")
          ...
          >
            <SelectTrigger className="h-10 bg-white text-left">
              <SelectValue placeholder={t("reference.restoreSourcePlaceholder")}>
                {fileRestore && selectedReverseContext
                ...
                <SelectItem
                  ...
                  textValue={
                    fileRestore
                      ...
                      : `${context.source_action_code || t("reference.historyAction")} · ${context.source_item_id}`
                  }
      ...
      {fileRestore && selectedRestoreDetails ? (
        <div className="grid overflow-hidden rounded-xl border border-blue-100 bg-white sm:grid-cols-2">
          ...
          <div className="min-w-0 border-t border-blue-100 px-3 py-2.5 sm:border-l sm:border-t-0">
            <div className="text-[10px] text-slate-400">
