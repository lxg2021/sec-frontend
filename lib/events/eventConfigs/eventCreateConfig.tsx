...
// Header 配置
export const EVENT_CREATE_HEADER: HeaderConfig = {
  title: { key: "EventName" },
  badges: [],
  fields: [
...
// Card 配置
export const EVENT_CREATE_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "ManualReset", label: "Manual Reset", icon: "RefreshCw", color: "text-gray-600" },
      { key: "InitialState", label: "Initial State", icon: "info", color: "text-gray-600" },
    ],
  },
  {
