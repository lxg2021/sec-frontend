...
// ServicePause事件的Header配置
export const SERVICE_PAUSE_HEADER: HeaderConfig = {
  title: {
    key: "ServiceName",
  },
  badges: [],
...
// ServicePause事件的Card配置
export const SERVICE_PAUSE_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "ServiceControlCode", label: "Control Code", icon: "PauseCircle", color: "text-yellow-500", monospace: true },
    ],
  },
  {
