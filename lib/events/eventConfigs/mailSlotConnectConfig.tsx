...
// Header 配置
export const MAILSLOT_CONNECT_HEADER: HeaderConfig = {
...
// Card 配置
export const MAILSLOT_CONNECT_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    color: "text-blue-600",
    fields: [
      { key: "MailSlotName", label: "MailSlot Name", icon: "FileText", color: "text-gray-600", monospace: true },
    ],
  },
  {
