...
// Cross Memory Execute事件的Header配置
export const CROSS_MEMORY_EXECUTE_HEADER: HeaderConfig = {
  title: {
    key: "ProcessName",
  },
  badges: [
...
// Cross Memory Execute事件的Card配置
export const CROSS_MEMORY_EXECUTE_CARD: SectionConfig[] = [
  {
