...
import { Hash, FileText, FolderOpen, Activity, Info, Key } from "lucide-react"

// Header 配置
export const FILE_WRITE_HEADER: HeaderConfig = {
  title: { key: "FileName" },
  badges: [
    {
      key: "Description",
...
// Card 配置
export const FILE_WRITE_CARD: SectionConfig[] = [
  {
