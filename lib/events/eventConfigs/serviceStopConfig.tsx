...
// ServiceStop事件的Header配置
export const SERVICE_STOP_HEADER: HeaderConfig = {
  title: {
    key: "ServiceName",
  },
  badges: [],
...
// ServiceStop事件的Card配置
export const SERVICE_STOP_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "ServiceControlCode", label: "Control Code", icon: "Terminal", color: "text-gray-600", monospace: true },
    ],
  },
  {
