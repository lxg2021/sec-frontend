...
import { Hash, FileText, FolderOpen, Activity, Info, Clock, Shield, Fingerprint, Key } from "lucide-react"
import { Badge } from "@/components/ui/badge"

// Header 配置
export const REGKEY_RENAME_HEADER: HeaderConfig = {
...
// Card 配置
export const REGKEY_RENAME_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "NewName", label: "New Name", icon: "FolderOpen", color: "text-gray-600", monospace: true, truncate: true, maxLength: 50, showInPopover: true, copyable: true },
