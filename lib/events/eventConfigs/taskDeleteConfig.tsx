...
// TaskDelete事件的Header配置
export const TASK_DELETE_HEADER: HeaderConfig = {
  title: {
    key: "TaskName",
  },
  badges: [
...
// TaskDelete事件的Card配置
export const TASK_DELETE_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    color: "text-blue-600",
    fields: [
      { key: "TaskName", label: "Task Name", icon: "FileText", color: "text-gray-600", bold: true },
      { key: "TaskPath", label: "Task Path", icon: "FolderOpen", color: "text-gray-600", monospace: true },
    ],
  },
  {
