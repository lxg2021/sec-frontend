...
import { Hash, FileText, FolderOpen, Activity, Info, Key, HardDrive, Fingerprint, Clock, Shield } from "lucide-react"

// Header 配置
export const FILE_SET_EA_HEADER: HeaderConfig = {
  title: { key: "FileName" },
  badges: [
...
// Card 配置
export const FILE_SET_EA_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "Description", label: "Description", icon: "Info", color: "text-gray-600" },
