...
// Header配置
export const BITS_JOB_CHANGE_STATE_HEADER: HeaderConfig = {
  title: { key: "JobName", default: "Unknown Job" },
  badges: [],
  fields: [
...
// Card配置
export const BITS_JOB_CHANGE_STATE_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "JobStatus", label: "Job Status Code", icon: "Tag", color: "text-gray-600" },
    ],
  },
  {
