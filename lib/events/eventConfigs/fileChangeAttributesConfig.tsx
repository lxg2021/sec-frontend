...
// Header 配置
export const FILE_CHANGE_ATTRIBUTES_HEADER: HeaderConfig = {
  title: { key: "FileName" },
  badges: [
    {
      key: "Signature",
...
// Card 配置
export const FILE_CHANGE_ATTRIBUTES_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "Flag", label: "File Attribute Flag", icon: "Flag", color: "text-gray-600" },
      { key: "OrgCreateTime", label: "Original Create Time", icon: "Clock", color: "text-gray-600" },
      { key: "NewCreateTime", label: "New Create Time", icon: "Clock", color: "text-gray-600" },
      {
        key: "Signature",
