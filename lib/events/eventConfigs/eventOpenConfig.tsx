...
// Header 配置
export const EVENT_OPEN_HEADER: HeaderConfig = {
  title: { key: "EventName" },
  badges: [],
  fields: [
...
// Card 配置
export const EVENT_OPEN_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "InheritHandle", label: "Inherit Handle", icon: "Info", color: "text-gray-600" },
    ],
  },
  {
