...
export const WMI_CONSUMER_HEADER: HeaderConfig = {
...
export const WMI_CONSUMER_CARD: SectionConfig[] = [
    {
    ...
    },
    {
        ...
        fields: [
            ...
            { key: "Class", label: "Consumer Class", icon: "List", color: "text-gray-600", bold: true },
