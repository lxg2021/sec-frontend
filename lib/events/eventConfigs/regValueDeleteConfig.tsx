...
// Header 配置
export const REGVALUE_DELETE_HEADER: HeaderConfig = {
...
// Card 配置
export const REGVALUE_DELETE_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    color: "text-blue-600",
    fields: [
      { key: "ObjectName", label: "Registry Value", icon: "Database", color: "text-gray-600", monospace: true, truncate: true, maxLength: 50, showInPopover: true, copyable: true },
