...
// Header 配置
export const FILE_RENAME_HEADER: HeaderConfig = {
...
// Card 配置
export const FILE_RENAME_CARD: SectionConfig[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "NewFileName", label: "New File Name", icon: "FolderOpen", color: "text-gray-600", monospace: true },
