...
import BaselineDashboardPage  from "../baseline/page"
...
export default function WatchPointMainFrame() {
  ...
  const menuItems = [
    ...
    { id: "baseline", icon: ShieldCheck, label: "安全基线", 
      submenu: [
        { id: "baselinedashboard", icon: LayoutDashboard, label: "基线Dashboard" }
      ],
    },
  ...
  const renderPageContent = () => {
    const pageComponents = {
      ...
      baselinedashboard: <BaselineDashboardPage />,
    }
